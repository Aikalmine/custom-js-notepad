        ...
        $(document).ready(function () {
            ...
            document.getElementById("newFile").addEventListener("click", New);
            document.getElementById("openFile").addEventListener("click", Open);
            document.getElementById("saveFile").addEventListener("click", Save);
            document.getElementById("saveAsFile").addEventListener("click", Save_As);
            document.getElementById("printDocument").addEventListener("click", Print);
            document.getElementById("openToolBar").addEventListener("click", Open);
            document.getElementById("toolBarSave").addEventListener("click", Save);
            document.getElementById("toolBarCut").addEventListener("click", Cut);
            document.getElementById("toolBarCopy").addEventListener("click", Copy);
            document.getElementById("toolBarPaste").addEventListener("click", Paste);
            document.getElementById("toolBarUndo").addEventListener("click", Undo);
            document.getElementById("toolBarRedo").addEventListener("click", Redo);
            document.getElementById("toolBaZoomOut").addEventListener("click", DecSize);
            document.getElementById("toolBarInSize").addEventListener("click", IncSize);
            document.getElementById("newFileName").addEventListener("click", saveFile);
            document.getElementById("cancelSaveFile").addEventListener("click", cancelSaveFile);
            document.getElementById("viewZoomIn").addEventListener("click", IncSize);
            document.getElementById("viewZoomOut").addEventListener("click", DecSize);
            document.getElementById("editUndo").addEventListener("click", Undo);
            document.getElementById("editRedo").addEventListener("click", Redo);
            document.getElementById("editCut").addEventListener("click", Cut);
            document.getElementById("editCopy").addEventListener("click", Copy);
            document.getElementById("editPaste").addEventListener("click", Paste);
            document.getElementById("editDel").addEventListener("click", Del);
            document.getElementById("editSelectAll").addEventListener("click", SelectAll);
            document.getElementById("fileElem").addEventListener("change", loadFile);
            //if( browser=="Chrome" )
            //	TextLinesToggle();
            setCaret(0);
            SetBar(1);
        ...
        function Save() {
            ...
            var name = params && params.filename ? params.filename : '';
